        ...
        <div class="header__wrap">
            <router-link to="/">
                <span>
                    <svg
                        ...
                        version="1.1"
                        viewBox="0 0 390.13 390.12"
                        xml:space="preserve"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
                            d="m132.64 177.86c31.162 0 56.508-34.014 56.508-75.834 0-41.817-25.347-75.841-56.508-75.841-31.153 0-56.502 34.023-56.502 75.841 0 41.82 25.349 75.834 56.502 75.834z"
                        />
                        <path
                            d="m300.25 251.63c-1.159-1.579-2.27-3.068-2.864-4.348-12.635-27.046-47.27-58.931-103.38-59.724l-2.159-0.012c-55.25 0-89.627 30.197-103.38 58.469-0.475 0.967-1.52 2.222-2.627 
                        ...
                        />
                        <path
                            d="m252.8 177.86c31.147 0 56.499-34.014 56.499-75.834 0-41.817-25.352-75.841-56.499-75.841-31.165 0-56.511 34.023-56.511 75.841 0 41.82 25.346 75.834 56.511 75.834z"
                        />
                        <path
                            d="m345.6 138.92c-24.975 0-44.521 25.901-44.521 58.967 0 33.051 19.558 58.955 44.521 58.955 24.961 0 44.531-25.904 44.531-58.955 0-33.065-19.558-58.967-44.531-58.967z"
                        />
                        <path
                            d="m89.048 197.88c0-33.065-19.558-58.967-44.522-58.967-24.965 0-44.526 25.902-44.526 58.967 0 33.051 19.561 58.955 44.526 58.955s44.522-25.904 44.522-58.955z"
                        />
                    </svg>
                </span>
            ...
            <div>
                ...
                <div v-if="isError" class="error">
                    <p>
                        We are sorry but your search
                        <b>"{{ breedType }}"</b> did not match any breed
                    </p>
                </div>
            </div>
        </div>
        ...
        processForm() {
            ...
            if (this.doglist.includes(tempBreed)) {
                ...
                if (tempBreed === this.$store.getters.getCurBreed) {
                    ...
                    this.$store.dispatch('getByBreed', tempBreed).then(() => {
                        this.isLoading = false;
